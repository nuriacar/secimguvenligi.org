...
- **Tetikleyici kelimelere dikkat:** "acil", "skandal", "ücretsiz", "ifşa", "en iyiler" gibi kelimeler tıklama dürtüsü yaratmak için özel seçilir. Bu kelimelerle gelen mesaj ve linklere karşı ekstra dikkatli ol.
- **Otomatik çevrilmiş mesajlar:** Tanımadığın birinden dil bilgisi bozuk, otomatik çevrilmiş gibi görünen "Filana sayfa bıraktı, görmek için tıkla" tarzı mesajlar gelirse bunlar bot hesaplardan gönderilen oltalamadır. Tıklama.
...
- **Daha fazla örnek ve detay için [İnternet Tarayıcı Güvenliği →](/İnternet-tarayici-guvenligi/).**
...
- **Senaryo:** Birisi senin adına, fotoğrafınla sahte hesap açar. Arkadaşlarına, akrabalarına "Benim, eski hesabım kapandı" diyerek eklenir ve para ister ya da bilgi toplar.
...
- **Yap:** Profil fotoğrafında "Bu benim tek resmi hesabım" şeklinde bir doğrulama ifadesi kullan.
...
<li>Tüm sosyal medya hesaplarında iki adımlı doğrulama açık</li>
...
2. Ayarlar ve gizlilik > İki adımlı doğrulama > Doğrulayıcı uygulaması seç
3. Ayarlar ve gizlilik > Gizlilik > "Yakın arkadaşlar" dışındaki kişilerin mesaj göndermesini engelle

**X (Twitter):**
1. Ayarlar ve gizlilik > Güvenlik ve hesap erişimi > İki adımlı doğrulama aç
...
**Facebook:**
1. Ayarlar > Güvenlik ve giriş > İki adımlı doğrulama aç
