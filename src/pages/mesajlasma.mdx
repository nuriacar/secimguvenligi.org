...
<li>İki aşamalı doğrulama (6 haneli PIN) aktif</li>
...
ProtonMail, uçtan uca şifreli e-posta hizmetidir. Normal e-posta (Gmail, Yahoo, Hotmail) sağlayıcıları e-postalarını okuyabilir. ProtonMail ise mesajlarını şifreler, sadece sen ve alıcı okuyabilir.
