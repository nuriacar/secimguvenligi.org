...
**Saldırgan gözüyle:** Seçim günü kaos demektir. Kaos, saldırgan için fırsattır. Herkesin telaşlı olduğu, açık ağlara atladığı, telefonu masada unuttuğu bir saatte tek bir hata yeter. Saldırgan senden daha akıllı değil, sadece senin dikkat dağınıklığını bekliyor. Stresli anında 3 saniye durup düşünmek, en iyi güvenlik önlemidir.

## <span class="heading-num">17.1</span> Açık Kablosuz Ağ (Wi-Fi) Yasak
...
## <span class="heading-num">17.2</span> Telefonu Sahipsiz Bırakma
...
## <span class="heading-num">17.3</span> Fotoğraf ve Video Paylaşımına Dikkat
...
## <span class="heading-num">17.4</span> QR Kod Tuzağı
...
- **Yap:** Karekod taradığında açılan İnternet adresini oku. Tanıdık bir adres değilse girme.
...
## <span class="heading-num">17.5</span> Halka Açık Bilgisayar ve Kiosk Güvenliği
...
## <span class="heading-num">17.6</span> Seçim Propagandası ve Dijital Kanıt
...
## <span class="heading-num">17.7</span> Sandık Başında Dijital Güvenlik
...
## <span class="heading-num">17.8</span> Seçim Günü İletişim Planı
...
- SMS bazen İnternet kesintisinde bile çalışır. Acil durum planına SMS seçeneğini de ekle.
...
<Scenario label="Senaryo: Sahte Sandık Bilgilendirme">
Seçim günü sabahı telefonuna bir WhatsApp mesajı düşer: "Sandık numaran değişti, yeni yeriniz XYZ Okulu. Acilen gidin." Mesaj arkadaş grubunda hızla yayılıyor. Hiç kimse kaynağını kontrol etmiyor. Sen de panikle yola çıkıyorsun. Yolda açık Wi-Fi'lı bir kafeye uğruyorsun, mobil verin bitmiş. "Sandık yerini bir doğrulayayım" diyerek oltalama sayfasına tıklıyorsun. Sayfa YSK'nın birebir kopyası. Kart bilgilerini de girmeni istiyor. Oysa YSK asla kart bilgisi istemez ve sandık yeri seçmen kartına işlenmiştir. Bir saniye dur, resmi kaynaktan doğrula, asla panikle hareket etme.
</Scenario>

<Scenario label="Senaryo: Sandık Sonucu İletimi">
Sandık kapanıyor, oyları saydın. Sonucu parti merkez ofisine iletmen gerekiyor. WhatsApp grubuna yazmaya çalıştın ama uygulama çalışmıyor. Şebeke yüklü. Çözüm: önceden ikinci bir iletişim kanalı belirle (Signal, SMS, telefon). Sonucu önce şifreli kanaldan (Signal) ilet. Sandık çevresindeki fotoğraflarda diğer kişilerin yüzleri görünmesin. Sonuçları ilettikten sonra telefonunu kilitle, ekran kilidi açık olsun.
</Scenario>
