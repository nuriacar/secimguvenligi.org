...
**Saldırgan gözüyle:** Deepfake için sesinin 30 saniyesi yeter. Telefon konuşmaların, videoların, hatta bir röportajın: hepsi senin sesini kopyalamak için malzeme. Arkadaşın arar, "çok acil para gönder" derse duyguna değil, önceden belirlediğin güven kelimesine güven.

## <span class="heading-num">40.1</span> Nedir?
...
## <span class="heading-num">40.2</span> Gerçek Vakalar
...
## <span class="heading-num">40.3</span> Seni Nasıl Etkiler?
...
## <span class="heading-num">40.4</span> Korunma Yöntemleri
...
2. **İkinci adım:** Yapay zeka modelini bu veriyle eğiterek inandırıcı sahte içerik üretir (mağdurun kendi verisini İnternette açık bırakması).
3. **Üçüncü adım:** Sahte içerik yayılır: itibar zedelenir, seçmenler yanıltılır veya şantaj yapılır (zararın İnternete yayılması).
