...
**Gerçek olay:** 2010'da ABD ve İsrail'in ortak operasyonuyla İran'ın Natanz nükleer tesisine sızan Stuxnet solucanı, USB bellek aracılığıyla fiziksel ortamdan yayıldı. İnternet bağlantısı olmayan, tamamen izole bir tesisteki bilgisayarlara bulaşmak için enfekte USB bellekler bilerek ortama bırakıldı. Bu olay, USB cihazlarının ne kadar tehlikeli olabileceğinin bilinen en büyük örneğidir. Masada bulduğun bir USB bellek bile küresel bir operasyonun parçası olabilir.
...
- **Kural:** Kamuya açık Wi-Fi ağlarında (kafe, havalimanı, otel, AVM) İnternete çıkarken mutlaka VPN kullan.
...
- **Windows:** Windows Defender varsayılan olarak yeterlidir. Ücretsiz antivirüs yazılımları (Avast, AVG) gereksizdir, sistemi şişirir.
...
İnternetteki her site için aynı parolayı kullanmak en büyük hatalardan biridir. Bir siteye sızıldığında tüm hesapların çalınır. Oysa her site için farklı, güçlü parolalar kullanman gerekir. Bunları aklında tutman imkansızdır. İşte burada parola yöneticisi devreye girer.

- **Ne işe yarar:** Tüm parolalarıni tek bir ana parolayla korunan bir kasada tutar. Sen sadece bu tek ana parolayı hatırlarsın. Geri kalan her şeyi uygulama senin yerine halleder: güçlü parolalar üretir, sitelere otomatik doldurur, hangi parolanın ele geçirildiğini bildirir.
...
- **Nasıl kurulur:**
  ...
  4. Mevcut parolalarıni tek tek kasa ekle veya tarayıcıdan içe aktar.
  5. Tarayıcının kendi parola kaydetme özelliğini kapat, Bitwarden kullan.
...
- **Dikkat:** Ana parolanı kimseyle paylaşma. "Parolamı unuttum" diyen birine bile asla ana parolanı söyleme. Bitwarden hesabına iki adımlı doğrulama (2FA) ekle.

<Alert level="tip">
Parola yöneticisi kullanmak "tüm yumurtaları tek sepete koymak" gibi görünebilir ancak durum tam tersidir: her sitede aynı parolayı kullanmak tüm yumurtaları tek sepete koymaktır. Bir site çalındığında hepsi gider. Parola yöneticisi ise her yumurtayı ayrı bir sepete koyup tüm sepetleri tek bir anahtarla kilitler.
</Alert>
