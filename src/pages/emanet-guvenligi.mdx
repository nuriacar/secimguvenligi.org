...
## <span class="heading-num">18.1</span> Kısa Süreli Verme (Arama, şarkı açma, harita)
...
## <span class="heading-num">18.2</span> Tam Teslim (Satış, tamir, devir)
...
<li>Galeri yedeğini aldın mı?</li>
<li>Google / Apple ID çıkışını yaptın mı?</li>
<li>e-Devlet uygulamalarından çıkış yaptın mı?</li>
<li>Banka uygulamalarından çıkış yaptın mı?</li>
<li>SIM kartı çıkardın mı?</li>
<li>Hafıza kartını çıkardın mı?</li>
<li>Fabrika ayarlarına döndürdün mü?</li>
</Checklist>

## <span class="heading-num">18.3</span> Geri Alınca Ne Yapılır?
...
2. Pil kullanımında şüpheli artış var mı: Ayarlar > Pil > Pil kullanımı
3. Veri kullanımında anomali var mı: Ayarlar > Ağ ve İnternet > Veri kullanımı
...
## <span class="heading-num">18.4</span> Telefon Tamircisine Verirken
