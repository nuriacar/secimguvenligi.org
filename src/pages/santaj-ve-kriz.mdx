...
## <span class="heading-num">23.1</span> Altın Kural
...
## <span class="heading-num">23.2</span> Adım Adım Ne Yapılır?
...
5. **Hesap ve cihaz güvenliğini derhal gözden geçir:** Şantaj materyali nasıl ele geçirildi? Hangi açıktan sızdı? Kök nedeni bul ve kapat. Eğer bir hesabından sızdıysa [Hesap Çalındığında Acil Protokol](/hesap-calma/) bölümüne git. Parolalarını değiştir, iki aşamalı doğrulama aç.
...
<li>Hesap güvenliği kontrol ediliyor (parolalar değiştiriliyor, iki aşamalı doğrulama açılıyor)</li>
</Checklist>

## <span class="heading-num">23.3</span> Cinsel İçerikli Şantaj (Sextortion) Senaryosu
...
## <span class="heading-num">23.4</span> Kamu Görevlisi Özel: Medya ve Kriz İletişimi
...
## <span class="heading-num">23.5</span> Yalan Bilgi ile Şantaj (Deepfake)
...
<DoDont items={[
  ...
  { text: 'Kriz iletişim danışmanıyla birlikte hareket et (kamoyu figürüysen)', type: 'do', level: 'best' },
